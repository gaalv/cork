...
import { folders, notes, recentNotes, tags } from '../data/mock'
...
export function LayoutMinimalCommand() {
  ...
  return (
    <div className="relative grid h-full grid-cols-[56px_1fr] bg-[var(--color-noxe-bg)]">
      {/* Slim icon rail */}
      <aside className="z-10 flex h-full flex-col items-center justify-between border-r border-[var(--color-noxe-border)] bg-[var(--color-noxe-panel)] py-4">
      ...
      <div className="relative flex h-full min-w-0 flex-col">
        {/* Top bar */}
        <header className="flex h-14 shrink-0 items-center gap-3 border-b border-[var(--color-noxe-border)] bg-[var(--color-noxe-panel)]/80 px-6 backdrop-blur">
          {view.kind === 'note' ? (
            <button
              onClick={goHome}
