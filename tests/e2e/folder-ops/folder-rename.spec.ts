...
const notes = [
  { id: "root", path: path.join(fixturePath, "Welcome.md"), title: "Welcome", folder: "", size: 1, mtime: Date.UTC(2026, 4, 6) },
  { id: "project", path: path.join(fixturePath, "projects/Roadmap.md"), title: "Roadmap", folder: "projects", size: 1, mtime: Date.UTC(2026, 4, 6) },
];
