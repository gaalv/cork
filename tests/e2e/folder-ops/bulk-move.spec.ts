...
const notes = [
  { id: "welcome", path: path.join(fixturePath, "Welcome.md"), title: "Welcome", folder: "", snippet: "", size: 1, mtime: Date.UTC(2026, 4, 6) },
  { id: "roadmap", path: path.join(fixturePath, "projects/Roadmap.md"), title: "Roadmap", folder: "projects", snippet: "", size: 1, mtime: Date.UTC(2026, 4, 6) },
  { id: "daily", path: path.join(fixturePath, "daily/Today.md"), title: "Today", folder: "daily", snippet: "", size: 1, mtime: Date.UTC(2026, 4, 6) },
];
