...
import { writeAttachment } from "@/services/assetIngest";
import { isImagePath } from "@/services/assetResolver";
...
async function ingestFile(
  file: File,
): Promise<{ relativePath: string; fileName: string; isImage: boolean } | null> {
  try {
